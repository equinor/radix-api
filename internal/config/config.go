...
type Config struct {
	...
	ClusterEgressIps   []string `envconfig:"RADIX_ACTIVE_CLUSTER_EGRESS_IPS" required:"true" desc:"Comma separated list of Egress IPs of the cluster, e.g. 192.168.84.0/30,10.0.0.0/30"`
