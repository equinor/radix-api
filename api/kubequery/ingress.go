...
// GetIngressesForEnvironments returns all Ingresses for the specified application and environments.
// Go routines are used to query Ingresses per environment, and number of concurrent Go routines is controlled with the parallelism parameter.
