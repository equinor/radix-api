...
func (deploy DeployHandler) GetLogs(appName, podName string, from time.Time, follow bool) (string, error) {
	...
	for _, env := range ra.Spec.Environments {
		...
		log, err := podHandler.HandleGetEnvironmentPodLog(appName, env.Name, podName, "", from, follow)
