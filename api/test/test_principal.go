...
func (p *TestPrincipal) Id() string            { return "anon." }
func (p *TestPrincipal) Name() string          { return "anonymous" }
func (p *TestPrincipal) IsAuthenticated() bool { return true }

func NewTestPrincipal() *TestPrincipal {
